...
if (!isset($_POST['puserclass'],$_POST['pemail'],$_POST['pusername'],$_POST['ppassword'],$_POST['ppasswordcheck'],$_POST['pforenames'],$_POST['psurname'])) {
  print('Insufficient data');
  exit;
  }

if ($_POST['ppassword'] != $_POST['ppasswordcheck']) {
...
$temparr=array('puserclass'=>'x','pusername'=>'x','ppassword'=>'x','ppasswordcheck'=>'x');
...
if ($checkok) {
  ...
  $regpost=array('userclass'=>$_POST['puserclass'],'name'=>$username,'loginid'=>$_POST['pusername'],'password'=>$_POST['ppassword'],'emailaddress'=>$_POST['pemail']);
