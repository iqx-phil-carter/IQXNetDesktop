	...
	$.extend($.fn, {
		multiSelect: function(o, callback) {
			...
			return this.each( function() {            
				...
				if( o.selectAll && !singleSelect ) html += '<label class="selectAll"><input type="checkbox" class="selectAll" />' + o.selectAllText + '</label>';
		...
		multiSelectOptionsShow: function() {
		  return this.each( function() {  
			...
			$(this).nextAll('.multiSelectOptions:first').css({ top:  offset.top + $(this).outerHeight() + 'px' });
			$(this).nextAll('.multiSelectOptions:first').css({ left: offset.left + 'px' });
